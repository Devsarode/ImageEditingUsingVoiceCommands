...
def maingui():
    ...
    mainwin.iconbitmap(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/logofull2_1TB_icon.ico")
    ...
    def logobtn_clicked():
        ...
        img1_logo = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\splashscreen.png")
        img1_logo = img1_logo.resize((900,400), PIL.Image.LANCZOS)
        ...
        logo_win.iconbitmap(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/logofull2_1TB_icon.ico")
    ...
    #logo button
    img_logo = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/elementslogo.png")
    img_logo = img_logo.resize((35,35), PIL.Image.LANCZOS)
    ...
    def import_options():
        ...
        import_win.iconbitmap(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/logofull2_1TB_icon.ico")
    ...
    def resize_image(width, height, label_width, label_height, image):
        ...
        if factor_one > 1 and factor_two > 1 and factor_one <2 and factor_two <2:
            ...
            return image.resize((width_resized, height_resized),PIL.Image.LANCZOS)
        else:
            width_resized = int( width*factor)
            height_resized = int(height*factor)
            return image.resize((width_resized, height_resized),PIL.Image.LANCZOS)
    ...
    # import button         
    img_import = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\save.png")
    img_import = img_import.resize((30,30), PIL.Image.LANCZOS)
    ...
    def settings_clicked():
        ...
        #save button
        img_save = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\save.png")
        img_save = img_save.resize((30,30), PIL.Image.LANCZOS)
        ...
        def logobtn_clicked():
            ...
            logo_win = Toplevel(mainwin)
            img1_logo = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\splashscreen.png")
            img1_logo = img1_logo.resize((600,400), PIL.Image.LANCZOS)
            photo_logo = ImageTk.PhotoImage(img1_logo)
            l1= Label(logo_win, bg="grey", image=photo_logo)
            l1.pack()
            l1.photo=photo_logo
    ...
    #settings button
    img_settings = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\settings.png")
    img_settings = img_settings.resize((30,32), PIL.Image.LANCZOS)
    ...
    #brightness button
    img_brightness = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\brightness.png")
    img_brightness = img_brightness.resize((30,32), PIL.Image.LANCZOS)
    ...
    #rotate button
    img_rotate = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\rotate.png")
    img_rotate = img_rotate.resize((30,32), PIL.Image.LANCZOS)
    ...
    #crop button
    img_crop = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\crop.png")
    img_crop = img_crop.resize((30,32), PIL.Image.LANCZOS)
    ...
    def filter_clicked():
        ...
        if current_img:
            ...
            #sharpness button
            img_sharp = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\filter.png")
            img_sharp = img_sharp.resize((30,30), PIL.Image.LANCZOS)
            ...
            #blur button
            img_blur = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\filter.png")
            img_blur = img_blur.resize((30,30), PIL.Image.LANCZOS)
            ...
            #enhance button
            img_enhance = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\filter.png")
            img_enhance = img_enhance.resize((30,30), PIL.Image.LANCZOS)
            ...
            #smooth button
            img_smooth = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\filter.png")
            img_smooth = img_smooth.resize((30,30), PIL.Image.LANCZOS)
            ...
            #smoothify button
            img_smooth_more = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\filter.png")
            img_smooth_more = img_smooth_more.resize((30,30), PIL.Image.LANCZOS)
            ...
            #detail button
            img_detail = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\filter.png")
            img_detail = img_detail.resize((30,30), PIL.Image.LANCZOS)
            ...
            #emboss button
            img_emboss = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\filter.png")
            img_emboss = img_emboss.resize((30,30), PIL.Image.LANCZOS)
            ...
            #contour button
            img_contour = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\filter.png")
            img_contour = img_contour.resize((30,30), PIL.Image.LANCZOS)
            ...
            img_bw = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\filter.png")
            img_bw = img_bw.resize((30,30), PIL.Image.LANCZOS)
    ...
    #filer button
    img_filter = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\filter.png")
    img_filter = img_filter.resize((30,32), PIL.Image.LANCZOS)
    ...
    #add text function
    img_addtext = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\addtext.png")
    img_addtext = img_addtext.resize((30,32), PIL.Image.LANCZOS)
    ...
    #contrast button
    img_contrast = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/contrast.png")
    img_contrast = img_contrast.resize((35,35), PIL.Image.LANCZOS)
    ...
    def flip_clicked():
        ...
        if current_img:
            ...
            flipright = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/undo.png")
            flipright = flipright.resize((40,40), PIL.Image.LANCZOS)
            ...
            #flip top- botton
            fliptop = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/redo.png")
            fliptop = fliptop.resize((40,40), PIL.Image.LANCZOS)
    ...
    #flip button
    img_flip = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/flip.png")
    img_flip = img_flip.resize((35,35), PIL.Image.LANCZOS)
    ...
    #Saturation button
    img_saturation = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/saturation.png")
    img_saturation = img_saturation.resize((37,37), PIL.Image.LANCZOS)
    ...
    #undo button
    img_undo = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/undo.png")
    img_undo = img_undo.resize((40,40), PIL.Image.LANCZOS)
    ...
    # redo button
    img_redo = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/redo.png")
    img_redo = img_redo.resize((40,40), PIL.Image.LANCZOS)
    ...
    #mic button 
    img_mic = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\mic.png")
    img_mic = img_mic.resize((66,72), PIL.Image.LANCZOS)
    ...
    saved_win.iconbitmap(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/logofull2_1TB_icon.ico")
    ...
    tic_img=Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/tick.png")
    image_resized =tic_img.resize((65,65), PIL.Image.LANCZOS)
    ...
    def save():
        ...
        if current_img == None :                                                                                     ## if tried to save without importing image
            ...
            save_win.iconbitmap(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/logofull2_1TB_icon.ico")
            ...
            img_mic2 = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/assets\mic.png")
            img_mic2 = img_mic2.resize((33,36), PIL.Image.LANCZOS)
...
if __name__ == "__main__":
    ...
    # mixer.init
    splash_img = Image.open(r"D:/Image-Editing-Using-Voice-Commands-1/elements2.0Images/splashscreen/"+ random_number + ".png")
    splash_img = splash_img.resize((900,563), PIL.Image.LANCZOS)
